      ...
      <main>
        <section id="inicio" className="relative px-5 pb-20 pt-32 lg:px-8 lg:pb-28 lg:pt-40">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1fr_0.94fr] lg:gap-20">
            ...
            <div className="relative mx-auto w-full max-w-[570px] lg:mr-0"><div className="absolute -left-7 top-12 z-10 hidden rounded-2xl border border-white bg-white px-4 py-3 shadow-xl sm:block"><div className="flex items-center gap-2 text-sm font-bold text-[#31564c]"><Check size={17} className="rounded-full bg-[#dff1e4] p-0.5 text-[#4e9674]" /> Especialista em crianças</div></div><div className="relative aspect-[0.88] overflow-hidden rounded-[42px] rounded-bl-[110px] bg-[#d2e5d8] shadow-2xl shadow-[#28584c]/15"><img src="https://images.pexels.com/photos/7078774/pexels-photo-7078774.jpeg" alt="Fisioterapeuta atendendo criança em casa" className="h-full w-full object-cover object-center" /></div><div className="absolute -bottom-5 -right-4 flex items-center gap-3 rounded-2xl border border-white bg-white p-4 shadow-xl sm:right-7"><span className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#edf7ef] text-[#478d6b]"><Clock3 size={22} /></span><div><p className="text-xs text-[#769087]">Atendimentos</p><p className="text-sm font-bold text-[#28584c]">Seg a Sáb · 7h às 19h</p></div></div></div>
          </div>
        </section>
